...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],     # For local dev and Render
...
def download_if_missing(path: Path, url: str) -> None:
    """
    Download .pth file from the given URL if it does not exist.
    Used to pull model weights from Google Drive at runtime.
    """
